<footer class="bg-dark pt-5 ">
    <div class="container text-white">
        <div class="row">
            ...
            <div class="col-md-3 mt-3">
                <ul class="list-unstyled">
                    <li class="mb-3 text-muted"><small>Admin</small></li>
                    <li><a href="home.php" class="text-white footer-text altcizgikaldir"> Admin Panel</li></a>
                    <li><a href="projeler.php" class="text-white footer-text altcizgikaldir"> Projeler</li></a>
                    <li><a href="fotograflar.php" class="text-white footer-text altcizgikaldir"> Fotoğraflar</li></a>
                    <li><a href="ayarlar.php" class="text-white footer-text altcizgikaldir"> Ayarlar</li></a>
                </ul>
            </div>
